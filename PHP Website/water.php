...
<body id="page-top">
    ...
    <?php
        ...
        $sql_wlevel = "SELECT wlevel FROM sensors ORDER BY id DESC LIMIT 1";
        $sql_wtemp = "SELECT wtemp FROM sensors ORDER BY id DESC LIMIT 1";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card shadow mb-4 ">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Current Water Level</h6>
                                </div>
                                <div class="card-body">
                                    <div class=" mb-4">
                                        <?php
                                            if ($result = $conn->query($sql_wlevel)) {
                                                while ($row = $result->fetch_assoc()) {
                                        ...
                                        <div class="card h2 bg-white shadow align-items-center">
                                            <div class="card-body">
                                                ...
                                                <?php
                                                    ...
                                                    else{echo "img/wlevel_critical.png";}
                                                ?> " width="60" height="60">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card shadow mb-4 ">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Current Water Temperature</h6>
                                </div>
                                <div class="card-body">
                                    <div class=" mb-4">
                                        <?php
                                            if ($result = $conn->query($sql_wtemp)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    $row_wtemp = $row["wtemp"];
                                        ?>
                                        <div class="card h2 bg-white shadow align-items-center">
                                            <div class="card-body">
                                                ...
                                                <?php echo $row_wtemp . "<sup> o</sup>C";?>
                                                <img src="img/wtemp.png" width="60" height="60">
                    ...
                    <div id="data" class="row justify-content-center">
                        ...
                        <div class="col-lg-10 card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Aquarium Water Temperatures</h6>
                            </div>
                            <div class="card-body">
...
<script>
        ...
        document.getElementById("download")
            .addEventListener("click", () => {
                ...
                var opt = {
                    margin: 0.1,
                    filename: 'WaterSensorData(Aquasense).pdf',
