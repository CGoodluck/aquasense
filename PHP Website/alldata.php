...
<head>
    ...
    <title>AquaSense - All Data</title>
                    ...
                    <div id="data" class="row justify-content-center">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">All Aquarium Sensor Data</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>Date</th>
                                                <th>Time</th>
                                                <th>Water Temp ( <sup>o</sup>C )</th>
                                                <th>pH</th>
                                                <th>Water Level</th>
                                                <th>Air Temp ( <sup>o</sup>C )</th>
                                                <th>Humidity ( % )</th>
                                                <th>Light</th>
