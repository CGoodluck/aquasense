...
<body id="page-top">
    ...
    <?php
        ...
        $sql_ph = "SELECT ph FROM sensors ORDER BY id DESC LIMIT 1";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card shadow mb-4 ">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Current pH</h6>
                                </div>
                                <div class="card-body">
                                    <div class=" mb-4">
                                        <?php
                                            if ($result = $conn->query($sql_ph)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    $row_ph = $row["ph"];
                                        ?>
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="card shadow mb-4 ">
                                ...
                                <div class="card-body">
                                    <img class="img-fluid mt-0 mb-0" style="width: 75rem;"src="img/phscale.png">
                                </div>
                            </div>
                    ...
                    <div id="data" class="row justify-content-center">
                        ...
                        <div class="col-lg-10 card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Aquarium pH Readings</h6>
                            </div>
                            <div class="card-body">
...
<script>
        ...
        document.getElementById("download")
            .addEventListener("click", () => {
                ...
                var opt = {
                    margin: 0.1,
                    filename: 'pHSensorData(Aquasense).pdf',
